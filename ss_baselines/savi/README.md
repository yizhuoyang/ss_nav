...
```
 ...
 python ss_baselines/savi/run.py --run-type eval --exp-config /home/Disk/yyz/sound-spaces/ss_baselines/savi/config/semantic_audionav/savi.yaml EVAL_CKPT_PATH_DIR data/pretrained_weights/semantic_audionav/savi/best_val.pth EVAL.SPLIT test USE_SYNC_VECENV True RL.DDPPO.pretrained False TASK_CONFIG.SIMULATOR.CONTINUOUS_VIEW_CHANGE False TASK_CONFIG.TASK.SENSORS [\"POINTGOAL_WITH_GPS_COMPASS_SENSOR\",\"SPECTROGRAM_SENSOR\",\"AUDIOGOAL_SENSOR\",\"POSE_SENSOR\",\"EGOMAP_SENSOR\"] SENSORS [\"RGB_SENSOR\",\"DEPTH_SENSOR\"] EXTRA_RGB True DISPLAY_RESOLUTION 512 TASK_CONFIG.SIMULATOR.USE_RENDERED_OBSERVATIONS False RL.PPO.use_belief_predictor False TEST_EPISODE_COUNT 1000 